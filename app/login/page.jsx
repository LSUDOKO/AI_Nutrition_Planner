...
import { ChefHat, Mail, Lock, AlertCircle, LogIn, UserPlus, ArrowRight, Info, CheckCircle } from 'lucide-react';
          ...
          {showSuccessMessage ? (
            ...
            >
              ...
              <div className="p-4 sm:p-6 pt-2 sm:pt-4">
                ...
                {/* Form */}
                <form onSubmit={activeTab === 'signin' ? handleSubmit : handleRegister}>
